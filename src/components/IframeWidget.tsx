  ...
  return (
    <div className="my-3 relative group">
      ...
      <button
        ...
        className="absolute top-2 right-2 p-1.5 text-gray-400 hover:text-gray-600 bg-white/80 hover:bg-white rounded shadow-sm opacity-0 group-hover:opacity-100 transition-opacity"
